...
if(USE_RUST)
  ...
  # myrustlib)
  corrosion_import_crate(MANIFEST_PATH "${RUST_DIR}/pawrprustlib/Cargo.toml")
  ...
  if(MSVC)
    ...
    # link C++ code.
    corrosion_set_env_vars(pawrprustlib-crate "CFLAGS=-MDd" "CXXFLAGS=-MDd")
  endif()
